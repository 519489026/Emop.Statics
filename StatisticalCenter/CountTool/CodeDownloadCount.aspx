<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeDownloadCount.aspx.cs" Inherits="StatisticalCenter.CountTool.CodeDownloadCount" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Export() {
            $("#frmExport").attr("src", "ajax.ashx?action=GetWayCountExport&resourceId=" + $("#txtBookGuidLink").val() + "&startDate=" + $("#textTimeStart").val() + "&endDate=" + $("#textTimeEnd").val());
        }
    </script>
    <style type="text/css">
        .styleoflist {
...
<body style="overflow:hidden">
    <form id="form1" runat="server">
        ...
        <div style="width: 850px">
            <div>
                ...
                <div style="float: left; margin-left: 10px;">
                    <asp:Button runat="server" ID="btnSearch" Text="查询" CssClass="buttonstyle" OnClick="btnSearch_Click" />
                    &nbsp;&nbsp;
            ...
            <div style="height: 240px">
                <table style="margin-top: 15px; background-color: white" id="titletable">
                    <tr>
                        ...
                        <td style="width: 140px; text-align: center">二维码名称</td>
                        <td style="width: 150px; text-align: center">扫码次数</td>
                        <td style="width: 150px; text-align: center">扫码人数</td>
                        <td style="width: 150px; text-align: center">下载次数</td>
                        <td style="width: 150px; text-align: center">下载人数</td>
                    </tr>
                    ...
                    <asp:Repeater runat="server" ID="repData">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center;" title="<%#Eval("CTRName") %>">
                                ...
                                <td style="text-align: center">
                                    <%#Eval("CTCPersonBrowseCount") %>
                                </td>
                                <td style="text-align: center">
                                    <%#Eval("CTCDownLoadCount") %>
                                </td>
                                <td style="text-align: center">
                                    <%#Eval("CTCPersonDownloadCount") %>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <%--<script>
        ...
        function BindData() {
            ...
            var now = GetEndTime();
            var id = $("#CodeID option:selected").text();
            if (id == "") {
                id = 0;
            }
            var index = 0;
            ...
            ///CountTool/ajax.ashx?action=GetWayCountData&resourceId=1&startDate=2015-01-01&endDate=2016-01-01&pageIndex=1&pageSize=10
            angular.module('mainApp', []).controller('countController', function ($http, $scope) {
                $http.get('ajax.ashx?action=GetWayCountData&resourceId=' + id + '&startDate=' + start + '&endDate=' + end + '&pageIndex='+index+'&pageSize=10').success(function (data) {
