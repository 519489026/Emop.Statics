<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookBuyingCount.aspx.cs" Inherits="StatisticalCenter.BookCount.BookBuyingCount" %>
        ...
        <div ng-app="mainApp" ng-controller="countController" style="width: 850px;overflow:auto">
            ...
            <table style="margin-top: 15px; background-color: white">
                <tr>
                    ...
                    <td style="width: 70px; text-align: center">梦想钻</td>
                    <td style="width: 70px; text-align: center">梦想币</td>
                ...
                <tr>
                    ...
                    <td style="width: 70px; text-align: center" id="mxzNumber"></td>
                    <td style="width: 70px; text-align: center" id="coinNumber"></td>
                    <td style="width: 100px; text-align: center">
            ...
            <div style="height: 360px">
                <table id="titletable" style="margin-top: 20px;">
                    <tr class="trTitle">
                        ...
                        <td style="width: 100px; text-align: center">购买数量</td>
                        <td style="width: 100px; text-align: center">梦想钻</td>
                        <td style="width: 100px; text-align: center">梦想币</td>
                    </tr>
                </table>
                ...
                <table id="contenttable" style="display: none; line-height: 30px;">
                    <tr ng-repeat="itemx in resultList">
                        ...
                        <td style="width: 140px; text-align: center" title="{{itemx.BookName}}">
                            <div style="width: 140px; text-align: center; overflow: hidden; white-space: nowrap; text-overflow: ellipsis">
                                {{itemx.BookName}}
                            </div>
                        </td>
                        <td style="width: 140px; text-align: center" title="{{itemx.PressName}}">
                            <div style="width: 140px; text-align: center; overflow: hidden; white-space: nowrap; text-overflow: ellipsis">
                                {{itemx.PressName}}
                            </div>
                        </td>
                        <td style="width: 100px; text-align: center">{{itemx.BuyCount}}</td>
                        <td style="width: 100px; text-align: center">{{itemx.MxzCount}}</td>
                        <td style="width: 100px; text-align: center">{{itemx.CoinCount}}</td>
                    </tr>
                </table>
            </div>
            <div style="clear: both; height: 10px;"></div>
    ...
    <script>
        ...
        angular.module('mainApp', []).controller('countController', function ($http, $scope) {
            $http.get('ajax.ashx?action=GetUserPressTable').success(function (data) {
                $http.get('ajax.ashx?action=GetBuyBookCountData&pressId=' + pressid + '&bookGuid=' + bookGuid + '&startDate=' + start + '&endDate=' + end + '&pageIndex=' + index + '&pageSize=10').success(function (result) {
