            ...
            <div style="width: 820px;">
                <table>
                    <tr class="trTitle">
                        ...
                        <td style="width: 220px; text-align: center">操作</td>
                    </tr>
                </table>
                ...
                <table id="contenttable" ng-app="mainApp" ng-controller="countController" style="display: none">
                    <tr ng-repeat="item in dataList">
                        ...
                        <td style="width: 220px; text-align: center">
                            <div style="width:220px;word-wrap:break-word;word-break:break-all">{{item.CTRUrl}}</div>
                        </td>
                        <td style="width: 180px;text-align: center" ng-dblclick="StartUpdate($index+1)">
                            <div title="{{item.CTRName}}" id="beforeClick{{$index+1}}" style="width:180px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis">{{item.CTRName}}</div>
